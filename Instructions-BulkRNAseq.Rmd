...
Download the tutorial notebook provided for this session:
   - **File Name**: `bulk_rnaseq_workflow.ipynb`
   - [Download the file](sandbox:/mnt/data/bulk_rnaseq_workflow.ipynb).
...
2. Upload the `bulk_rnaseq_workflow.ipynb` file from your local machine.
